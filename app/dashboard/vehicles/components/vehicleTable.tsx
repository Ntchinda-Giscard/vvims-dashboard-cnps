...
export default function VehicleTable({datas, onEdit, onAddTask, onDelete, onSee}:any) {
        ...
        <ScrollArea h={400} onScrollPositionChange={({y}) => setScrolled(y !== 0)}>
            ...
            <Table withRowBorders miw={700}>
                <Table.Thead className={cx(classes.header, {[classes.scrolled]: scrolled})}>
                    <Table.Tr>
                        <Table.Th style={{ color: "#404044" }}> Brand </Table.Th>
                        <Table.Th style={{ color: "#404044" }}> License </Table.Th>
                        <Table.Th style={{ color: "#404044" }}> Colors </Table.Th>
                        <Table.Th style={{ color: "#404044" }}> Make </Table.Th>
