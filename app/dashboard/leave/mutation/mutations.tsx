...
export const INSERT_LEAVE = gql`
  mutation InsertLeave($region: String!, $comment: String!, $employee_id: uuid!, $end_date: date!, $start_date: date!, $leave_type: leave_type_enum!, $other_description: String = null, $file: String = null) {
